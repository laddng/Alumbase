<?php
  ...
  $result = db_query("UPDATE `users`(`first_name`, `last_name`, `major_id`, `graduation_year`, `email_address`) VALUES (".$first_name.", ".$last_name.", ".$major_id.", ".$graduation_year.", ".$email_address.")");
